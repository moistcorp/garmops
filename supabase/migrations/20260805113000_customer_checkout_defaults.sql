-- Persist reusable customer checkout defaults atomically.
-- Order-specific values continue to be snapshotted separately during payment finalisation.
...
begin
  ...
  if not p_billing_same_as_shipping then
