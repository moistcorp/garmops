...
| Zoho Invoice India | Free | ₹0; up to 2 users, 3 projects, and 500 invoices/year | 400 invoices/year; review immediately before adding a second operational user or when broader accounting is required |
...
- [Zoho Invoice India pricing](https://www.zoho.com/in/invoice/pricing/)
...
- Reliable production: Vercel Pro (currently $20/month) plus Supabase Pro (currently from $25/month), while R2, Resend, Zoho Invoice, and Turnstile remain inside their early-volume free allowances. Planning floor: $45/month before tax and usage, approximately ₹5,000–₹5,500/month using the implementation guide's conservative budgeting.
...
Record Supabase database/MAU/egress/backup state; R2 storage and Class A/B operations; Resend daily/monthly sends and failures; Zoho yearly invoice count and users; Vercel usage/cron health; PostgreSQL job backlog/dead jobs; and PayU reconciliation exceptions.
