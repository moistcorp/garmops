...
export const landingPages = {
  ...
  customHoodies: {
    ...
    heroImage: '/products/boxy-fit-hoodie-320gsm.webp',
    heroImageAlt: '320 GSM boxy-fit hoodie for a custom bulk merchandise order',
    ...
    productHeading: 'Compare regular and boxy hoodies',
    productIntroduction: 'Both current hoodies use 320 GSM 80/20 cotton-poly fleece. Compare the catalogue construction and fit before approving artwork or collecting sizes.',
    featuresHeading: 'Choose the hoodie silhouette',
    features: [
      ...
      { title: 'Boxy-fit hoodie', description: 'A wider, oversized silhouette with dropped shoulders, kangaroo pocket and an oversized hood with drawcord.' },
      ...
      { title: 'Product-specific sizing', description: 'Regular and boxy fits are not interchangeable. Use the measurement chart for the selected product before locking the size split.' },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        features: [
          ...
          { title: 'Size planning', description: 'Collect sizes against the exact regular- or boxy-fit chart and keep a controlled contingency only where the order requires it.' },
