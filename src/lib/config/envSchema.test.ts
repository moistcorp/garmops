...
describe("server environment validation", () => {
  ...
  it("requires accounts, Supabase, and exact R2 configuration for uploads", () => {
    expect(() =>
      ...
      "Invalid server environment configuration: NEXT_PUBLIC_ACCOUNTS_ENABLED, NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY, NEXT_PUBLIC_SUPABASE_URL, R2_ACCESS_KEY_ID, R2_ACCOUNT_ID, R2_PRIVATE_BUCKET, R2_S3_ENDPOINT, R2_SECRET_ACCESS_KEY, SUPABASE_SECRET_KEY"
    );
  });
