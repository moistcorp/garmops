...
export type ValidatedUploadRequest = Readonly<{ orderId?: string; designProjectId?: string; staffQuoteId?: string; kind: BrowserUploadKind; visibility: "customer" | "staff_only"; originalFilename: string; safeFilename: string; extension: string; contentType: string; byteSize: number; sha256?: string }>;
