export const CUSTOM_ORDER_TERMS_VERSION = "full-payment-v1-2026-08-04";
export const CUSTOM_ORDER_PRIVACY_VERSION = "privacy-v1-2026-08-04";
export const CUSTOM_ORDER_TERMS_DOCUMENT_HASH =
...
export function currentCustomTermsEvidence() {
  return Object.freeze({
    version: CUSTOM_ORDER_TERMS_VERSION,
    privacyVersion: CUSTOM_ORDER_PRIVACY_VERSION,
    documentHash: CUSTOM_ORDER_TERMS_DOCUMENT_HASH,
  });
}
