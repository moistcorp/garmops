...
export const sampleOrderItemSchema = z
  .object({
...
export const submitSampleOrderRequestSchema = z
  .object({
...
export type SubmitSampleOrderRequest = z.infer<
  typeof submitSampleOrderRequestSchema
>;
