...
export default function CustomerOrderLifecyclePanel({
  ...
  return <div className="space-y-5">
    ...
    <section className="techpack-surface rounded-[4px] border p-6">
      <div className="flex items-center gap-2"><FileArchive size={18} className="text-[#1D49B4]" /><h3 className="font-semibold">Order files</h3></div>
