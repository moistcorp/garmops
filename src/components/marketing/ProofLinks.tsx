  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20">
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          <p className="mb-3 text-xs font-medium uppercase tracking-[0.18em] text-(--text-muted)">Documented work</p>
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-2">
        {caseStudies.map(study => (
          <Link
            ...
            className="storefront-interactive-card techpack-panel group grid overflow-hidden rounded-sm border sm:grid-cols-[0.42fr_0.58fr]"
          >
            ...
            <div className="p-5 sm:p-6">
              <p className="text-xs font-medium uppercase tracking-widest text-(--text-muted)">{getCaseStudyIndustry(study.industryId)?.name ?? study.industryId}</p>
              ...
              <p className="mt-4 font-mono text-[10px] uppercase tracking-[0.08em] text-(--text-muted)">
