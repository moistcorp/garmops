  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20">
      ...
      <dl className="mt-8 grid gap-4">
        {faqs.map(faq => (
          <div key={faq.question} className="techpack-panel grid gap-3 rounded-sm border p-5 sm:p-6 md:grid-cols-2 md:gap-8">
            <dt className="text-sm font-semibold leading-6 text-(--text-primary)">{faq.question}</dt>
