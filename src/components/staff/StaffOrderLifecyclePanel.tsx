...
export default function StaffOrderLifecyclePanel({ order, role, files, approvals, approvers, designVersions, shipments, shipmentEvents }: {
  ...
  return <div className="space-y-6">
    {!sampleOrder ? <section className="liquid-glass-surface rounded-3xl border p-6">
      <div className="flex items-center gap-2"><ClipboardCheck size={18} className="text-[#4F8B92]" /><h2 className="text-lg font-semibold">Versioned artwork approval</h2></div>
