...
export default async function SystemRecoveryPanel() {
  ...
  return <section className="techpack-surface rounded-sm border p-5 sm:p-6">
    <div className="flex flex-wrap items-start justify-between gap-4">
      <div><p className="font-mono text-xs font-semibold uppercase tracking-[0.12em] text-(--color-accent)">Payments & integrations</p><h2 className="mt-2 text-lg font-semibold">Recovery centre</h2><p className="mt-1 text-xs text-black/45">Cron health, pending PayU attempts, invoices and email jobs.</p></div>
      <ProcessJobsNowForm />
    </div>
