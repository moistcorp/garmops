  ...
  return (
    <div className="flex justify-center">
      <a
        ...
        className="techpack-control inline-flex h-9 items-center gap-1.5 rounded-sm border px-3 text-xs font-semibold text-(--text-primary)/70 hover:!border-(--color-accent)/45 hover:!bg-white/60 hover:text-(--color-accent)"
      >
