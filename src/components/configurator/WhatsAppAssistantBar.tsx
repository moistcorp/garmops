  ...
  return (
    <div className="flex justify-center">
      <a
        ...
        className="configurator-glass-control inline-flex h-9 items-center gap-1.5 rounded-[4px] border px-3 text-xs font-semibold text-[#111111]/70 hover:!border-[var(--color-accent)]/45 hover:!bg-white/60 hover:text-[var(--color-accent)]"
      >
