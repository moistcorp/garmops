    ...
    <div className="flex flex-col gap-2">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p
            className="flex items-center gap-1 text-xs font-semibold leading-none tracking-normal text-[var(--text-primary)]/70"
            title="The smallest ordered garment size determines the safe area used across every garment."
          >
            Artwork safe area
            <Info size={12} aria-hidden="true" className="text-[var(--text-primary)]/35" />
          </p>
          <p className="mt-1.5 text-sm font-medium leading-tight text-[var(--text-primary)]/80">
        ...
        <select
          ...
          className="techpack-control h-9 w-[4.75rem] appearance-none rounded-[4px] border px-2.5 pr-7 text-xs font-semibold leading-none tracking-normal text-[var(--text-primary)]/75 outline-none focus:!border-[var(--color-accent)]/60"
        >
          {SIZE_ORDER.map((size) => {
