...
const inputClass =
  "liquid-glass-control w-full rounded-xl border px-4 py-3 text-sm transition-colors focus:!border-[var(--color-teal)] focus:outline-none";
const labelClass =
    ...
    return (
      <div className="app-liquid-bg min-h-[70vh] animate-pulse px-4 py-10 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 h-9 w-64 rounded-lg bg-[#ECE7DF]" />
          <div className="grid gap-8 lg:grid-cols-3 lg:gap-12">
            <div className="liquid-glass-panel h-64 rounded-2xl border lg:col-span-2" />
  ...
  if (!items.length && !savedOrder) {
    return (
      <div className="app-liquid-bg flex min-h-[70vh] items-center justify-center px-4 py-16 text-center sm:px-6 sm:py-24">
        <div className="liquid-glass-surface w-full max-w-lg rounded-[30px] border p-8">
          ...
          <Link
            href="/products"
            className="mt-7 inline-block rounded-full bg-[var(--color-teal)] px-6 py-3 text-sm font-medium text-white"
          >
            Browse samples
          </Link>
        </div>
    ...
    <div className="app-liquid-bg min-h-[70vh] px-4 py-10 sm:px-6 sm:py-16">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-3 lg:gap-12">
          ...
          >
            <section className="liquid-glass-panel rounded-[26px] border p-5 sm:p-7">
              <p className="mb-5 text-xs font-medium uppercase tracking-widest text-[#111111]/40">
                Account and contact
              </p>
              <div className="mb-5 rounded-xl border border-black/7 bg-white/45 px-4 py-3 text-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="flex">
                    <span className="liquid-glass-control rounded-l-xl border border-r-0 px-4 py-3 text-sm text-black/50">
                      +91
                    </span>
                    <input
                      id="sample-phone"
                      ...
                      className="liquid-glass-control min-w-0 flex-1 rounded-r-xl border px-4 py-3 text-sm focus:!border-[var(--color-teal)] focus:outline-none"
          ...
          <aside className="flex flex-col gap-4">
            <div className="liquid-glass-surface flex flex-col gap-4 rounded-[28px] border p-6 lg:sticky lg:top-28">
              ...
              <button
                ...
                className="w-full rounded-full bg-[var(--color-teal)] py-3.5 text-sm font-medium text-white transition-colors hover:bg-[var(--color-teal-dark)] disabled:cursor-not-allowed disabled:opacity-50"
              >
                {loading
                  ? savedOrder
