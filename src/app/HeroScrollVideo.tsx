...
export default function HeroScrollVideo() {
  return (
    <section className="techpack-canvas grid lg:min-h-[88vh] lg:grid-cols-2">
      ...
      <div className="relative flex min-h-[430px] items-center justify-center overflow-hidden bg-(--color-cream-soft) lg:min-h-full">
        <Image
        ...
        >
          ...
          <div className="flex items-end justify-between gap-5">
            <div>
              <p className="text-base font-semibold text-(--text-primary)">Premium Oversized T-Shirt</p>
  ...
  return (
    <section className="techpack-section">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-24">
        ...
        <div className="relative aspect-[4/3] overflow-hidden rounded-sm border border-[#E5E5E5] bg-black sm:aspect-video">
          <video
