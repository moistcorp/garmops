        ...
        <div className="grid gap-10 lg:grid-cols-3 lg:gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-10">
              ...
              <h1 className="mb-4 text-3xl font-bold leading-tight tracking-tight text-[var(--text-primary)] sm:text-4xl">
                {cs.title}
              </h1>
              <p className="text-base leading-relaxed text-[var(--text-primary)]/60 sm:text-lg">{cs.excerpt}</p>
            </div>
            ...
            <div className="mb-10">
              ...
              <p className="text-[var(--text-primary)]/70 leading-relaxed text-sm">{cs.challenge}</p>
            </div>
            ...
            <div className="mb-10">
              ...
              <p className="text-[var(--text-primary)]/70 leading-relaxed text-sm">{cs.solution}</p>
            </div>
            ...
            <div className="techpack-panel mb-10 rounded-[4px] border p-5 sm:mb-12 sm:p-8">
              ...
              <p className="text-[var(--text-primary)] leading-relaxed text-sm font-medium">{cs.result}</p>
            </div>
            ...
            {cs.sections.map((section, i) => (
              <div key={i} className="mb-12">
                ...
                <p className="text-[var(--text-primary)]/60 leading-relaxed text-sm">{section.body}</p>
                {section.image && (
            ...
            {cs.testimonial && (
              <div className="techpack-surface mb-12 rounded-[4px] border p-5 sm:p-8">
                <p className="mb-6 text-xl font-semibold leading-snug tracking-tight text-[var(--text-primary)] sm:text-2xl">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[var(--text-primary)]">{cs.testimonial.author}</p>
                    <p className="text-xs text-[var(--text-primary)]/50">{cs.testimonial.role}</p>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="flex flex-col gap-6 lg:pt-20">
            ...
            <div className="techpack-surface rounded-[4px] border p-6">
              <p className="text-xs font-medium text-[var(--text-primary)]/40 uppercase tracking-widest mb-4">
                Project details
              </p>
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div key={item.label}>
                    <p className="text-xs text-[var(--text-primary)]/40 mb-0.5">{item.label}</p>
            ...
            <div className="techpack-panel rounded-[4px] border p-6">
              ...
              <ul className="flex flex-col gap-2">
                {cs.deliverables.map(d => (
                  <li key={d} className="flex gap-2 text-sm text-[var(--text-primary)]/70">
      ...
      {related.length > 0 && (
        <section className="py-12 sm:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <p className="text-xs font-medium text-[var(--text-primary)]/40 uppercase tracking-widest mb-8">
              More case studies
            </p>
              ...
              {related.map(cs => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col gap-2">
                    <span className="text-xs text-[var(--text-primary)]/30">{cs.industry}</span>
                    <h3 className="text-base font-semibold text-[var(--text-primary)] group-hover:underline leading-snug">
                      {cs.title}
                    </h3>
                    <p className="text-xs text-[var(--text-primary)]/50">{cs.quantity} pieces · {cs.turnaround}</p>
                  </div>
                </Link>
              ))}
            </div>
