  ...
  return (
    <div className="techpack-canvas">
      ...
      <section className="max-w-7xl mx-auto px-4 pb-10 pt-10 sm:px-6 sm:pb-12 sm:pt-20">
        <p className="text-xs text-(--text-primary)/40 font-medium mb-4 tracking-widest uppercase">Garmops</p>
        ...
        <p className="max-w-lg text-base leading-relaxed text-(--text-primary)/50 sm:text-lg">
      ...
      <section className="techpack-section py-12 sm:py-16">
        <div className="max-w-7xl mx-auto flex flex-col items-stretch justify-between gap-6 px-4 sm:px-6 md:flex-row md:items-center">
          <div className="text-left">
            ...
            <p className="text-(--text-primary)/50 text-sm">Custom apparel for brands, cafes, and companies. MOQ 50 pieces.</p>
          </div>
