  ...
  return <div className="space-y-6">
    ...
    <div className="grid gap-5 xl:grid-cols-[1.35fr_0.65fr]">
      <div className="space-y-5">
        ...
        <section className="techpack-surface rounded border p-6">
          <div className="flex items-center gap-2"><Clock3 size={18} className="text-(--color-accent)" /><h2 className="font-semibold">Production timeline</h2></div>
      ...
      <div className="space-y-5">
        <section className="techpack-surface rounded border p-6">
          <div className="flex items-center gap-2"><FileText size={18} className="text-(--color-accent)" /><h2 className="font-semibold">Project details</h2></div>
