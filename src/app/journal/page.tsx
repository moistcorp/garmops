  ...
  return (
    <div className="techpack-canvas">
      ...
      <section className="max-w-7xl mx-auto px-4 pb-12 sm:px-6 sm:pb-16">
        <div className="techpack-dark flex flex-col items-stretch gap-7 rounded-sm border p-6 sm:rounded-sm sm:p-10 md:flex-row md:items-start md:p-14">
          ...
          <Link href={`/journal/${posts[0].slug}`} className="shrink-0 self-stretch rounded-sm bg-white px-6 py-3 text-center text-sm font-medium text-(--color-navy) transition hover:bg-white/90 sm:self-end md:self-center">
            Read article
          </Link>
        </div>
      </section>
      ...
      <section className="techpack-section py-12 sm:py-16">
        <div className="max-w-7xl mx-auto flex flex-col items-stretch justify-between gap-6 px-4 sm:px-6 md:flex-row md:items-center">
          ...
          <div className="flex flex-col gap-3 min-[360px]:flex-row">
            ...
            <Link href="/contact" className="rounded-sm border border-(--color-accent) px-6 py-3 text-center text-sm font-medium text-(--color-accent) transition hover:bg-(--color-accent) hover:text-white">Contact us</Link>
          </div>
        </div>
      </section>
    </div>
